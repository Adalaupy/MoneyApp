...
const ScheduleModal = () => {
    ...
    const GetTempTime = () => {
        ...
        if (ScheduleEvery.length > 0) {
            ...
            return [ScheduleEvery[ScheduleEvery.length - 2], ScheduleEvery[ScheduleEvery.length - 1]]
    ...
    const WeekOption = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
    ...
    const DatePicker = (event, selectedDate) => {
        ...
        setTempDate([selectedDate.getDate(), selectedDate.getMonth() + 1, selectedDate.getFullYear()])
            ...
            return (
                ...
                <View style={styles.DateContainer}>
                    ...
                    <ModalSelector
                        ...
                        initValue={InitValue()}
                        onChange={(option) => { setTempDate([option.value]) }}
                    />
        ...
        switch (SchedulePeriod) {
            ...
            case "Yearly":
                ...
                return (
                    ...
                    <View style={styles.DateContainer}>
                        <MaterialIcons name='edit-calendar' size={30} />
                        <TextInput value={tempDate} onChange={setTempDate} style={styles.YearInput} inputMode="numeric" placeholder="Year" />
                    </View>
            ...
            case "Adhoc":
                ...
                return (
                    ...
                    <View style={styles.DateContainer}>
                        <MaterialIcons name='edit-calendar' size={30} />
                        <DateTimePicker onChange={DatePicker} value={DatePickerDisplay()} mode="date" />
                    </View>
        ...
        >
            <ScrollView style={styles.container}>
                ...
                <View style={styles.ItemNameContainer}>
                    ...
                    <TextInput style={styles.ItemNameText} placeholder="Schedule Item......." value={ScheduleItem} onChangeText={setScheduleItem} />
                </View>
                ...
                <View style={styles.TypeContainer}>
                    ...
                    >
                        <Text style={styles.TypeText('Income', ScheduleType)}>Income</Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text style={styles.TypeText('Expense', ScheduleType)}>Expense</Text>
                    </TouchableOpacity>
                ...
                <View style={styles.CateContainer}>
                    ...
                    <CategoryListModal setCate={setScheduleCate} setCateIcon={setScheduleCateIcon} currentCate={ScheduleCate} />
                ...
                <View style={styles.BtnContainer}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => { handle_Schedule_Cancel() }}>
                    ...
                    <TouchableOpacity
                        style={styles.LeftBtn}
                        onPress={() => { handle_Schedule_Submit() }}>
